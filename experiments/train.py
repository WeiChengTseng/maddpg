...
from recorder_list import Recorder
...
# python ./experiments/train.py --scenario simple_spread --num-episodes 60000 --exp_name simple_spread
# python ./experiments/train.py --scenario simple_adversary --num-episodes 60000 --exp_name simple_adversary
...
def train(arglist):
    with U.single_threaded_session():
        ...
        while True:
            ...
            # NOTE --------------------------------------------------
            recoder.add(obs_n, action_n, rew_n, done or terminal)
            # -------------------------------------------------------
        ...
        recoder.export_pickle(arglist.scenario)
